...
<div class="container mx-auto p-8">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-2xl mx-auto">
        ...
        <form action="{{ route('product.tambah') }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="Nama" name="Nama"
                           ...
                           placeholder="Contoh: Laptop Pro" value="{{ old('Nama') }}" required>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="Deskripsi" name="Deskripsi" rows="4"
                              ...
                              placeholder="Tulis deskripsi singkat produk di sini...">{{ old('Deskripsi') }}</textarea>
                ...
                <div>
                    ...
                    <input type="number" id="Stok" name="Stok"
                           ...
                           placeholder="0" value="{{ old('Stok') }}" required>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="Harga" name="Harga"
                               ...
                               placeholder="15000000" value="{{ old('Harga') }}" required>
                    </div>
                    @error('Harga')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
